...
Angular workspace containing a reusable npm library (`@onlyoffice/document-editor-angular`) for integrating ONLYOFFICE Document Server, plus a demo application. Currently targets **Angular 21** on branch `feature/angular-v-21`.
...
- **Library versioning**: Major version tracks Angular compatibility (v8.x = Angular 21)
