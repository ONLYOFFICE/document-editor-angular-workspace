...
Angular workspace containing a reusable npm library (`@onlyoffice/document-editor-angular`) for integrating ONLYOFFICE Document Server, plus a demo application. Currently targets **Angular 19** on branch `feature/angular-v-19`.
...
- **Library versioning**: Major version tracks Angular compatibility (v6.x = Angular 19)
